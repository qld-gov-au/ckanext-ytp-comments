...
commenting.add_url_rule('/<content_item_id>/comments/<comment_id>/edit', view_func=edit)
commenting.add_url_rule('/<content_type>/<content_item_id>/comments/<comment_id>/edit', view_func=edit)
commenting.add_url_rule('/<dataset_id>/comments/<parent_id>/reply', view_func=reply)
commenting.add_url_rule('/<content_type>/<dataset_id>/comments/<parent_id>/reply', view_func=reply)
commenting.add_url_rule('/<content_item_id>/comments/<comment_id>/delete', view_func=delete)
...
commenting.add_url_rule('/<content_item_id>/comments/<comment_id>/unflag', view_func=unflag)
